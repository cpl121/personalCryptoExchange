  ...
  <table>
    ...
    <tbody>
      ...
      >
        ...
        <td :class="a.changePercent24Hr.includes('-') ? 'text-red-600': 'text-green-600'"> {{a.changePercent24Hr}} </td>
        <td class="hidden sm:block">
  ...
  computed: {
    formatAssets() {
      this.assets.forEach(el => {
        ...
        el.marketCapUsd = numeral(el.marketCapUsd).format('($ 0.00 a)')
    ...
    filteredAssets() {
      ...
      return this.formatAssets.filter(a=> 
